...
eyebrow: "Odkrywanie niewidzialnego #01"
readingTime: 16
section_url: /odkrywanie-niewidzialnego/
section_label: Odkrywanie niewidzialnego
cover_brand: "FIZYKA · GRANICE INTUICJI #01"
cover_title: "KTO NAPRAWDĘ PRZYSPIESZA?"
cover_subtitle: "SWOBODNY SPADEK · KRZYWIZNA · PRZYCZYNOWOŚĆ"
cover_kind: loose
---
...
Krzywizny nie da się usunąć jednym wyborem układu współrzędnych na całym obszarze. Można zlikwidować lokalne „pole grawitacyjne” odczuwane przez pojedynczego spadającego obserwatora, ale nie można unieważnić relatywnego przyspieszania sąsiednich geodezyjnych. Właśnie to zachowanie jest geometrycznym, niezależnym od układu współrzędnych śladem grawitacji.
...
Eksperyment myślowy z nagłym zniknięciem Słońca działa na wyobraźnię, ponieważ światło potrzebuje około ośmiu minut i dwudziestu sekund, aby dotrzeć do Ziemi. Zmiana pola grawitacyjnego także nie może rozchodzić się szybciej od światła, dlatego w hipotetycznym scenariuszu Ziemia przez ten sam czas nie otrzymałaby informacji o zmianie źródła.
...
## Einstein znajduje się w telefonie
...
Newton i Einstein nie są dwoma konkurencyjnymi autorami opisującymi zupełnie inne wszechświaty. Newtonowski język siły jest niezwykle skutecznym przybliżeniem w słabych polach i przy małych prędkościach. Einstein pokazuje szerszą strukturę, w której swobodny ruch nie wymaga grawitacyjnego pchnięcia, a to, co odczuwamy jako ciężar, pochodzi od przeszkody odchylającej nas od geodezyjnej.

Dlatego bardziej precyzyjne pytanie brzmi:

> **Czy rozpatrywany obiekt porusza się swobodnie, czy jakaś niegrawitacyjna interakcja zmusza go do opuszczenia geodezyjnej?**
...
- [Einstein Online: zasada równoważności](https://www.einstein-online.info/en/explandict/equivalence-principle/)
- [Einstein Online: geometryczna grawitacja](https://www.einstein-online.info/en/GeomGravity/)
- [NIST: poprawki relatywistyczne w GPS](https://www.nist.gov/atomic-clocks/a-powerful-tool-for-science/putting-einstein-test)
- [LIGO/Virgo/Fermi: fale grawitacyjne i gamma z GW170817](https://dcc.ligo.org/P1700308/public)
- [LIGO/Virgo: obserwacja układu podwójnej gwiazdy neutronowej](https://dcc.ligo.org/LIGO-P170817/public)

<div class="lab-archive"><strong>Granica twierdzenia:</strong> „grawitacja nie jest siłą” opisuje geometryczną interpretację swobodnego ruchu w ogólnej teorii względności. Nie oznacza, że efekty pływowe, krzywizna albo przyczynowe zmiany pola są nierzeczywiste, ani że newtonowski model siły przestaje być doskonałym przybliżeniem w odpowiednim zakresie.</div>
